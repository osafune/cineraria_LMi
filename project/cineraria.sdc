...
set_clock_groups -asynchronous \
                 -group { \
                       avpll:inst1|altpll:altpll_component|avpll_altpll:auto_generated|wire_pll1_clk[0] \
                       avpll:inst1|altpll:altpll_component|avpll_altpll:auto_generated|wire_pll1_clk[1] \
                       CLOCK_50 \
                        } \
                 -group { \
                       syspll:inst7|altpll:altpll_component|syspll_altpll:auto_generated|wire_pll1_clk[0] \
                       syspll:inst7|altpll:altpll_component|syspll_altpll:auto_generated|wire_pll1_clk[1] \
                       syspll:inst7|altpll:altpll_component|syspll_altpll:auto_generated|wire_pll1_clk[2] \
                       CLOCK_50_2 \
                        } \
