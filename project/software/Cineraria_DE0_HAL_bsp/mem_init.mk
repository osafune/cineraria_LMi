...
MEM_0 := epcs_controller_boot_rom
$(MEM_0)_NAME := epcs_controller
...
$(MEM_0)_START := 0x0f000000
$(MEM_0)_END := 0x0f0007ff
$(MEM_0)_HIERARCHICAL_PATH := epcs_controller
$(MEM_0)_WIDTH := 32
...
epcs_controller: check_elf_exists $(HDL_SIM_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym $(MEM_0).flash
