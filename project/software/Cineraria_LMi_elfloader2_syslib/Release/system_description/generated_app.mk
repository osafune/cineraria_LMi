...
#
# Generated: 2012-01-29 08:49:32.239
...
QUARTUS_PROJECT_DIR = D:/PROJECT/DE0/cineraria_LMi

# the simulation directory is a subdirectory of the PTF directory
SIMDIR = $(QUARTUS_PROJECT_DIR)/nios2_fpu_sim

DBL_QUOTE := "


# macros defined by/for epcs_controller & ext_flash
...
flashfiles: $(EPCS_CONTROLLER_BOOT_ROM_FLASHTARGET_ALT_SIM_PREFIX)epcs_controller_boot_rom.flash $(EXT_FLASH_FLASHTARGET_ALT_SIM_PREFIX)ext_flash.flash
.PHONY: flashfiles
...
dummy_verifysysid_file:
	nios2-download $(JTAG_CABLE)                                --sidp=0x10000000 --id=0 --timestamp=1327788053
...
$(EXT_FLASH_FLASHTARGET_ALT_SIM_PREFIX)ext_flash.flash: $(ELF)
	...
	elf2flash --input=$(ELF) --flash= --boot=$(DBL_QUOTE)$(shell $(DBL_QUOTE)$(QUARTUS_ROOTDIR)/sopc_builder/bin/find_sopc_component_dir$(DBL_QUOTE) $(CPU_CLASS) $(QUARTUS_PROJECT_DIR))/$(BOOT_COPIER)$(DBL_QUOTE) --outfile=$(EXT_FLASH_FLASHTARGET_ALT_SIM_PREFIX)ext_flash.flash --sim_optimize=$(ALT_SIM_OPTIMIZE) --base=0x4000000 --end=0x43FFFFF --reset=$(CPU_RESET_ADDRESS)
