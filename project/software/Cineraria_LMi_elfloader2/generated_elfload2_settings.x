 ...
 *
 * Generated: 2012-01-29 08:50:10.674
 *
 */
...
MEMORY
{
    reset : ORIGIN = 0x0f000000, LENGTH = 32
    epcs_controller : ORIGIN = 0x0f000020, LENGTH = 2016
    ext_flash : ORIGIN = 0x04000000, LENGTH = 4194304
/*
    sdram_UNUSED : ORIGIN = 0x00000000, LENGTH = 32
    sdram : ORIGIN = 0x00000020, LENGTH = 8388576
*/
    sdram_UNUSED : ORIGIN = 0x00000000, LENGTH = 8380416
    sdram : ORIGIN = 0x007fe000, LENGTH = 8192
}

    /* Define symbols for each memory base-address */
 __alt_mem_epcs_controller = 0x0f000000 ;
 __alt_mem_ext_flash = 0x04000000 ;
 __alt_mem_sdram = 0x00000000 ;
...
PROVIDE( __alt_heap_limit    = 0x00800000 );
